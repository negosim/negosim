...
class AbstractAcceptanceStrategy(AcceptanceStrategyInterface):
    ...
    def __init__(self, utility_space: AbstractUtilitySpace, user_model: AbstractUserModel):
        """
        his class is used in BOA and EUBOA frameworks. one of the utility_space and user_model
