...
class BilateralSession:
    ...
    def __init__(self, protocol_name: str, analysis_man_name: str, deadline, deadline_type: str,
        ...
        try:
            ...
            nego_table = NegoTable(state_info, time_line, self.__party1.get_id(), self.__party2.get_id())
            self.__party1.set_nego_table(nego_table=nego_table)
            self.__party2.set_nego_table(nego_table=nego_table)
