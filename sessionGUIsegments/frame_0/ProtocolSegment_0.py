...
class ProtocolSegment_0(AbstractGUISegment):
    ...
    def get_widget(self):
        ...
        var_dict = self.get_current_horizontal_frame_var_dict()
        var_dict[0][0].set('Select a protocol')
        optionMenu_protocol = tk.OptionMenu(self.get_frame(), var_dict[0][0], *protocol_list)
